...
//        Ordenamiento.quickSort(filasV, 0, filasV.length - 1, columnIndex, "descendente");
    ...
    public void busquedaBinaria(Integer columnIndex) {
        ...
        int resultado = -1; //es -1 porque el resultado es el valor de una posicion, así que debe darte como minimo 0
        try {
            resultado = Busqueda.buscarBinario(columnValues, view.txtBuscarB.getText());
        } catch (Exception e) {
